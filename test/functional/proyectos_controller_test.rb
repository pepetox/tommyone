...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { Descripcion: @proyecto.Descripcion, Foto_link: @proyecto.Foto_link, Link: @proyecto.Link, Nombre: @proyecto.Nombre, terminado: @proyecto.terminado }
    end
  ...
  test "should update proyecto" do
    put :update, id: @proyecto, proyecto: { Descripcion: @proyecto.Descripcion, Foto_link: @proyecto.Foto_link, Link: @proyecto.Link, Nombre: @proyecto.Nombre, terminado: @proyecto.terminado }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
